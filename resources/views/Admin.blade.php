...
<body>
    <?php
$header=\App\Models\Getcustomer::all();
 ?>
                ...
                <div class="admin-header-info">
                    <div class="row">
                        <div class="col-2">
                            ...
                            {{$header}}
                            <input type="month" id="total-month" class="form-control">
                        </div>
                    </div>
                        ...
                        <div class="col-3">
                            <div class="admin-list">
                                ...
                                <div class="admin-tittle">
                                    ...
                                    <p class="totalcustomer">{{ $customer->count() }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="admin-list">
                                ...
                                <div class="admin-tittle">
                                    ...
                                    <p class="totalitem">{{ $item->count() }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="admin-list">
                                ...
                                <div class="admin-tittle">
                                    ...
                                    @foreach ($item_sale as $total)
                                        <p class="totalsale">{{ round($total->total_unitprice, 2) }}</p>
                                    @endforeach
                        ...
                        <div class="col-3">
                            <div class="admin-list">
                                ...
                                <div class="admin-tittle">
                                    ...
                                    @foreach ($totalqty as $qtys)
                                        <p class="totalqty">{{ round($qtys->qty) }}</p>
                                    @endforeach
                                </div>
                            </div>
                        </div>
